(defproject heptadecagon "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "heptadecagon.core/on-js-reload"
                ...
                :compiler {:main heptadecagon.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/heptadecagon.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/heptadecagon.js"
                           :main heptadecagon.core
